...
function deg2angle(deg, short) {
    ...
    var sec = (0, math_1.round)((deg - degPart - min / 60) * 3600, 3);
    var secParts = sec.toString().split('.');
    var degString = degPart + '° ';
    var minString = (0, math_1.pad)(min, 2) + '\' ';
    var secString = (secParts.length === 1 ? (0, math_1.pad)(sec, 2) : (0, math_1.pad)(secParts[0], 2) + '.' + secParts[1]) + '"';
...
function deg2time(angle) {
    ...
    var sec = (0, math_1.round)((time - hour - min / 60) * 3600, 3);
    var secParts = sec.toString().split('.');
    var hourString = sign + hour;
    var minString = (0, math_1.pad)(min, 2);
    var secString = secParts.length === 1 ? (0, math_1.pad)(sec, 2) : (0, math_1.pad)(secParts[0], 2) + '.' + secParts[1];
    return "".concat(hourString, "h ").concat(minString, "m ").concat(secString, "s");
}
