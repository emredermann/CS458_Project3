        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    m0 += dm;
                    if (cnt++ > 100) {
                        throw new Error("While loop overflow. Astronomical object has no transit on given day ".concat(jd0, "."));
                    }
                    _a.label = 4;
                case 4:
                ...
                case 5:
                    if (m0 < 0 || m0 >= 1) {
                        throw new Error("Astronomical object has no transit on given day ".concat(jd0, "."));
                    }
                    return [2, jd0 + m0];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    mH = _a.sent();
                    if (isNaN(mH)) {
                        throw new Error("Astronomical object cannot rise on given day ".concat(jd0, "."));
                    }
                    m1 = (0, angleCalc_1.normalizeAngle)(m0 - mH, 1);
                    dm = 0;
                    cnt = 0;
                    _a.label = 3;
                ...
                case 4:
                    ...
                    m1 += dm;
                    if (cnt++ > 100) {
                        throw new Error("While loop overflow. Astronomical object cannot rise on given day ".concat(jd0, "."));
                    }
                    _a.label = 5;
                case 5:
                ...
                case 6:
                    if (m1 < 0) {
                        throw new Error("Astronomical object cannot rise on given day ".concat(jd0, ". Rise happens the day before."));
                    }
                    if (m1 >= 1) {
                        throw new Error("Astronomical object cannot rise on given day ".concat(jd0, ". Rise happens the next day."));
                    }
                    return [2, jd0 + m1];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    mH = _a.sent();
                    if (isNaN(mH)) {
                        throw new Error("Astronomical object cannot set on given day ".concat(jd0, "."));
                    }
                    m2 = (0, angleCalc_1.normalizeAngle)(m0 + mH, 1);
                    dm = 0;
                    cnt = 0;
                    _a.label = 3;
                ...
                case 4:
                    ...
                    m2 += dm;
                    if (cnt++ > 100) {
                        throw new Error("While loop overflow. Astronomical object cannot set on given day ".concat(jd0, "."));
                    }
                    _a.label = 5;
                case 5:
                    if (Math.abs(dm) > 0.00001) return [3, 3];
                ...
                case 6:
                    if (m2 < 0) {
                        throw new Error("Astronomical object cannot set on given day ".concat(jd0, ". Set happens the day before."));
                    }
                    if (m2 >= 1) {
                        throw new Error("Astronomical object cannot set on given day ".concat(jd0, ". Set happens the next day."));
                    }
                    return [2, jd0 + m2];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    T = (0, timeCalc_1.julianDay2julianCenturiesJ2000)(jd0);
                    GAST = (0, timeCalc_1.getGreenwichApparentSiderealTime)(T);
                    m0 = (rightAscension - location.lon - GAST) / 360;
                    return [2, (0, angleCalc_1.normalizeAngle)(m0, 1)];
            }
        });
    });
}
...
function _getCorrectionsTransit(ObjConstructor, location, jd0, m) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, (0, interpolationCalc_1.getRightAscensionInterpolationArray)(ObjConstructor, jd0, 1)];
                case 1:
                    rightAscensionArray = _a.sent();
                    n0 = _getN0(jd0, m);
                    raInterpolated = (0, angleCalc_1.normalizeAngle)((0, interpolationCalc_1.tabularInterpolation3)(rightAscensionArray, n0));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    lat = location.lat;
                    latRad = (0, angleCalc_1.deg2rad)(lat);
                    return [4, (0, interpolationCalc_1.getRightAscensionInterpolationArray)(ObjConstructor, jd0, 1)];
                case 1:
                    rightAscensionArray = _a.sent();
                    return [4, (0, interpolationCalc_1.getDeclinationInterpolationArray)(ObjConstructor, jd0, 1)];
                case 2:
                    declinationArray = _a.sent();
                    n0 = _getN0(jd0, m);
                    raInterpolated = (0, angleCalc_1.normalizeAngle)((0, interpolationCalc_1.tabularInterpolation3)(rightAscensionArray, n0));
                    decInterpolated = (0, interpolationCalc_1.tabularInterpolation3)(declinationArray, n0);
                    dRad = (0, angleCalc_1.deg2rad)(decInterpolated);
                    return [4, _getLocalHourAngle(raInterpolated, location.lon, jd0, m)];
                case 3:
                    H = _a.sent();
                    HRad = (0, angleCalc_1.deg2rad)(H);
                    altitude = (0, coordinateCalc_1.equatorialSpherical2topocentricHorizontalByLocalHourAngle)(H, decInterpolated, lat).altitude;
...
function _getLocalHourAngle(raInterpolated, longitude, jd0, m) {
    var T = (0, timeCalc_1.julianDay2julianCenturiesJ2000)(jd0);
    var GAST = (0, timeCalc_1.getGreenwichApparentSiderealTime)(T);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    latRad = (0, angleCalc_1.deg2rad)(location.lat);
                    dRad = (0, angleCalc_1.deg2rad)(declination);
                    h0Rad = (0, angleCalc_1.deg2rad)(h0);
                    cosH0 = (Math.sin(h0Rad) - Math.sin(latRad) * Math.sin(dRad)) / (Math.cos(latRad) * Math.cos(dRad));
                    if (Math.abs(cosH0) > 1 && Math.abs(cosH0) <= 1.1) {
                        return [2, 0];
                    }
                    return [2, (0, angleCalc_1.rad2deg)(Math.acos(cosH0))];
            }
        });
    });
}
function _getN0(jd, m) {
    var _a = (0, timeCalc_1.julianDay2time)(jd), year = _a.year, month = _a.month;
    var dT = (0, timeCalc_1.getDeltaT)(year, month);
    return m + dT / 86400;
}
