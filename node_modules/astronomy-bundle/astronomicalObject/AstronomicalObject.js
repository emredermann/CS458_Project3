...
var conjunctionCalc_1 = require("../planets/calculations/conjunctionCalc");
...
var AstronomicalObject = (function () {
    function AstronomicalObject(toi, name) {
        if (toi === void 0) { toi = time_1.createTimeOfInterest.fromCurrentTime(); }
        if (name === void 0) { name = 'astronomical object'; }
        this.toi = toi;
        this.name = name;
        this.jd = 0.0;
        this.jd0 = 0.0;
    ...
    AstronomicalObject.prototype.getTimeOfInterest = function () {
        return this.toi;
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        coords = _a.sent();
                        return [2, (0, coordinateCalc_1.equatorialSpherical2topocentricSpherical)(coords, location, this.T)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        coords = _a.sent();
                        return [2, (0, coordinateCalc_1.equatorialSpherical2topocentricHorizontal)(coords, location, this.T)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        coords = _a.sent();
                        return [2, (0, distanceCalc_1.au2km)(coords.radiusVector)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2, (0, distanceCalc_1.au2km)(radiusVector) / lightSpeed_1.LIGHT_SPEED_KM_PER_SEC];
                }
            });
        });
    };
    AstronomicalObject.prototype.getConjunctionInRightAscensionTo = function (astronomicalObjectConstructor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, conjunctionCalc_1.getConjunctionInRightAscension)(this.constructor, astronomicalObjectConstructor, this.jd0)];
    ...
    AstronomicalObject.prototype.getConjunctionInLongitudeTo = function (astronomicalObjectConstructor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, conjunctionCalc_1.getConjunctionInLongitude)(this.constructor, astronomicalObjectConstructor, this.jd0)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
