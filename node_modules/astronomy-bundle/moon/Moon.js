...
var createSun_1 = __importDefault(require("../sun/createSun"));
var createEarth_1 = __importDefault(require("../earth/createEarth"));
var riseSetTransitCalc_1 = require("../utils/riseSetTransitCalc");
var time_1 = require("../time");
var standardAltitude_1 = require("../constants/standardAltitude");
var magnitudeCalc_1 = require("./calculations/magnitudeCalc");
var librationCalc_1 = require("./calculations/librationCalc");
var calculations_1 = require("./calculations");
var moonPhases_1 = require("./constants/moonPhases");
var diameters_1 = require("./constants/diameters");
var LunarX_1 = __importDefault(require("./events/LunarX"));
var LunarV_1 = __importDefault(require("./events/LunarV"));
var GoldenHandle_1 = __importDefault(require("./events/GoldenHandle"));
var Moon = (function (_super) {
    __extends(Moon, _super);
    function Moon(toi) {
        var _this = _super.call(this, toi, 'moon') || this;
        _this.sun = (0, createSun_1.default)(toi);
        _this.earth = (0, createEarth_1.default)(toi);
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2, (0, coordinateCalc_1.rectangularGeocentric2rectangularHeliocentric)(geocentricCoords, heliocentricCoordsEarth)];
                }
            });
        });
    };
    ...
    Moon.prototype.getGeocentricEclipticSphericalDateCoordinates = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                lon = calculations_1.moonCalc.getLongitude(this.T);
                lat = calculations_1.moonCalc.getLatitude(this.T);
                radiusVector = calculations_1.moonCalc.getRadiusVector(this.T);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        coords = _a.sent();
                        return [2, (0, apparentCoordinateCalc_1.correctEffectOfNutation)(coords, this.T)];
                }
            });
        });
    };
    Moon.prototype.getTransit = function (location) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, riseSetTransitCalc_1.getTransit)(Moon, location, this.jd0)];
                    case 1:
                        jd = _a.sent();
    ...
    Moon.prototype.getRise = function (location, standardAltitude) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, riseSetTransitCalc_1.getRise)(Moon, location, this.jd0, standardAltitude)];
                    case 1:
                        jd = _a.sent();
                        return [2, time_1.createTimeOfInterest.fromJulianDay(jd)];
                }
    ...
    Moon.prototype.getSet = function (location, standardAltitude) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, riseSetTransitCalc_1.getSet)(Moon, location, this.jd0, standardAltitude)];
                    case 1:
                        jd = _a.sent();
                        return [2, time_1.createTimeOfInterest.fromJulianDay(jd)];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        isWaxing = _a.sent();
                        return [2, (0, magnitudeCalc_1.getApparentMagnitudeMoon)(coordsHelio.radiusVector, coordsGeo.radiusVector, i, isWaxing)];
                }
            });
        });
    };
    ...
    Moon.prototype.getUpcomingNewMoon = function () {
        ...
        return calculations_1.moonPhaseCalc.getTimeOfInterestOfUpcomingPhase(decimalYear, moonPhases_1.MOON_PHASE_NEW_MOON);
    };
    Moon.prototype.getUpcomingFirstQuarter = function () {
        var decimalYear = this.toi.getDecimalYear();
        return calculations_1.moonPhaseCalc.getTimeOfInterestOfUpcomingPhase(decimalYear, moonPhases_1.MOON_PHASE_FIRST_QUARTER);
    };
    Moon.prototype.getUpcomingFullMoon = function () {
        var decimalYear = this.toi.getDecimalYear();
        return calculations_1.moonPhaseCalc.getTimeOfInterestOfUpcomingPhase(decimalYear, moonPhases_1.MOON_PHASE_FULL_MOON);
    };
    Moon.prototype.getUpcomingLastQuarter = function () {
        var decimalYear = this.toi.getDecimalYear();
        return calculations_1.moonPhaseCalc.getTimeOfInterestOfUpcomingPhase(decimalYear, moonPhases_1.MOON_PHASE_LAST_QUARTER);
    };
    Moon.prototype.getGeocentricLibration = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.getSelenographicLocationOfEarth()];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    };
    Moon.prototype.getSelenographicLocationOfEarth = function () {
        return __awaiter(this, void 0, void 0, function () {
            var coords;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        coords = _a.sent();
                        return [2, (0, librationCalc_1.getSelenographicLocation)(coords, this.T)];
                }
            });
        });
    };
    Moon.prototype.getSelenographicLocationOfSun = function () {
        return __awaiter(this, void 0, void 0, function () {
            var coords;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Moon.prototype.getGoldenHandle = function () {
        return new GoldenHandle_1.default(this.toi);
    };
    Moon.prototype.getLunarX = function () {
        return new LunarX_1.default(this.toi);
    };
    Moon.prototype.getLunarV = function () {
        return new LunarV_1.default(this.toi);
    };
    return Moon;
