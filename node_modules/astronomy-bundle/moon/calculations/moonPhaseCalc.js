...
var createTimeOfInterest = __importStar(require("../../time/createTimeOfInterest"));
...
function getTimeOfInterestOfUpcomingPhase(decimalYear, moonPhase) {
    var k = (0, math_1.round)((decimalYear - 2000) * 12.3685) + moonPhase;
    var T = k / 1236.85;
...
function _getPeriodicTermCorrections(k, T, moonPhase) {
    switch (moonPhase) {
        ...
        default:
            throw new Error("Invalid moon phase: ".concat(moonPhase));
    }
}
function _getPeriodicTermCorrectionsForNewMoon(k, T) {
    ...
    var omegaRad = (0, angleCalc_1.deg2rad)(omega);
...
function _getPlanetaryCorrections(k, T) {
    var A1 = (0, angleCalc_1.deg2rad)(299.77 + 0.107408 * k - 0.009173 * Math.pow(T, 2));
    var A2 = (0, angleCalc_1.deg2rad)(251.88 + 0.016321 * k);
    var A3 = (0, angleCalc_1.deg2rad)(251.83 + 26.651776 * k);
    var A4 = (0, angleCalc_1.deg2rad)(349.42 + 36.412478 * k);
    var A5 = (0, angleCalc_1.deg2rad)(84.66 + 18.206239 * k);
    var A6 = (0, angleCalc_1.deg2rad)(141.74 + 53.303771 * k);
    var A7 = (0, angleCalc_1.deg2rad)(207.84 + 2.453732 * k);
    var A8 = (0, angleCalc_1.deg2rad)(154.84 + 7.306860 * k);
    var A9 = (0, angleCalc_1.deg2rad)(34.52 + 27.261239 * k);
    var A10 = (0, angleCalc_1.deg2rad)(207.19 + 0.121824 * k);
    var A11 = (0, angleCalc_1.deg2rad)(291.34 + 1.844379 * k);
    var A12 = (0, angleCalc_1.deg2rad)(161.72 + 24.198154 * k);
    var A13 = (0, angleCalc_1.deg2rad)(239.56 + 25.513099 * k);
    var A14 = (0, angleCalc_1.deg2rad)(331.55 + 3.592518 * k);
