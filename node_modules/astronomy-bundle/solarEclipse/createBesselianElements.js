...
var loadBesselianElements_1 = __importDefault(require("./besselianElements/loadBesselianElements"));
function createBesselianElements(toi) {
    return __awaiter(this, void 0, void 0, function () {
        var jd0, besselianElementsArray;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jd0 = toi.getJulianDay0();
                    return [4, (0, loadBesselianElements_1.default)(jd0)];
                case 1:
                    besselianElementsArray = _a.sent();
                    if (!besselianElementsArray) {
                        throw new Error("No besselian elements found for ".concat(jd0));
                    }
                    return [2, _getBesselianElements(besselianElementsArray)];
            }
        });
    });
}
exports.default = createBesselianElements;
function _getBesselianElements(besselianElementsArray) {
    return {
