...
var PlanetTypes_1 = require("../types/PlanetTypes");
var time_1 = require("../../time");
var interpolationCalc_1 = require("../../utils/interpolationCalc");
function getConjunctionInRightAscension(obj1Constructor, obj2Constructor, jd0) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, (0, interpolationCalc_1.getRightAscensionInterpolationArray)(obj1Constructor, jd0, 2)];
                case 1:
                    raEphemerisObj1 = _a.sent();
                    return [4, (0, interpolationCalc_1.getRightAscensionInterpolationArray)(obj2Constructor, jd0, 2)];
                case 2:
                    ...
                    n = (0, interpolationCalc_1.tabularInterpolation5)(raEphemerisDiff);
                    return [4, (0, interpolationCalc_1.getDeclinationInterpolationArray)(obj1Constructor, jd0, 2)];
                case 3:
                    decEphemerisObj1 = _a.sent();
                    return [4, (0, interpolationCalc_1.getDeclinationInterpolationArray)(obj2Constructor, jd0, 2)];
                case 4:
                    decEphemerisObj2 = _a.sent();
                    decEphemerisDiff = _getEphemerisDiff(decEphemerisObj1, decEphemerisObj2);
                    declination = (0, interpolationCalc_1.getInterpolateValue5)(decEphemerisDiff, n);
                    return [2, {
...
function getConjunctionInLongitude(obj1Constructor, obj2Constructor, jd0) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, (0, interpolationCalc_1.getLongitudeInterpolationArray)(obj1Constructor, jd0, 2)];
                case 1:
                    lonEphemerisObj1 = _a.sent();
                    return [4, (0, interpolationCalc_1.getLongitudeInterpolationArray)(obj2Constructor, jd0, 2)];
                case 2:
                    ...
                    n = (0, interpolationCalc_1.tabularInterpolation5)(lonEphemerisDiff);
                    return [4, (0, interpolationCalc_1.getLatitudeInterpolationArray)(obj1Constructor, jd0, 2)];
                case 3:
                    latEphemerisObj1 = _a.sent();
                    return [4, (0, interpolationCalc_1.getLatitudeInterpolationArray)(obj2Constructor, jd0, 2)];
                case 4:
                    latEphemerisObj2 = _a.sent();
                    latEphemerisDiff = _getEphemerisDiff(latEphemerisObj1, latEphemerisObj2);
                    latitude = (0, interpolationCalc_1.getInterpolateValue5)(latEphemerisDiff, n);
                    return [2, {
                            toi: time_1.createTimeOfInterest.fromJulianDay(jd0 + n),
